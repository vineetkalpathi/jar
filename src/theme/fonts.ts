/**
 * The two faces, mapped from their Google Fonts assets to the names the tokens use.
 *
 ...
 * every weight and italic, and Metro bundles each one it can see: importing every face
