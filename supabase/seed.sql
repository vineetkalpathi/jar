...
-- Each night is stamped with the Household it happened in — Alice and Bob share The
-- Sofa, so that is where all of these took place (ADR-0010).
insert into viewing (title_id, user_id, household_id, watched_on) values
  ('7171e000-0000-4000-8000-000000000001', 'a11ce000-0000-4000-8000-000000000001', '50fa0000-0000-4000-8000-000000000001', current_date - 400),
  ('7171e000-0000-4000-8000-000000000001', 'a11ce000-0000-4000-8000-000000000001', '50fa0000-0000-4000-8000-000000000001', current_date - 700),
  ('7171e000-0000-4000-8000-000000000001', 'b0b00000-0000-4000-8000-000000000002', '50fa0000-0000-4000-8000-000000000001', current_date - 400),
  ('7171e000-0000-4000-8000-000000000004', 'a11ce000-0000-4000-8000-000000000001', '50fa0000-0000-4000-8000-000000000001', current_date - 30),
  ('7171e000-0000-4000-8000-000000000004', 'a11ce000-0000-4000-8000-000000000001', '50fa0000-0000-4000-8000-000000000001', current_date - 200),
  ('7171e000-0000-4000-8000-000000000004', 'a11ce000-0000-4000-8000-000000000001', '50fa0000-0000-4000-8000-000000000001', current_date - 500),
  ('7171e000-0000-4000-8000-000000000004', 'b0b00000-0000-4000-8000-000000000002', '50fa0000-0000-4000-8000-000000000001', current_date - 30),
  ('7171e000-0000-4000-8000-000000000003', 'b0b00000-0000-4000-8000-000000000002', '50fa0000-0000-4000-8000-000000000001', current_date - 12);
